package com.payline.payment.bizum.bean.configuration;
...
public class RequestConfiguration {
    ...
    public static com.payline.payment.bizum.bean.configuration.RequestConfiguration build(ContractParametersCheckRequest request){
        return new com.payline.payment.bizum.bean.configuration.RequestConfiguration( request.getContractConfiguration(), request.getEnvironment(), request.getPartnerConfiguration() );
    }
